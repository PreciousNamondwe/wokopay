...
export default function Features() {
  const features = [
    ...
    },
    {
      ...
      description: "End-to-end encryption and multi-factor authentication protect every currency in Africa. We prioritize safety above all else.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto text-lg leading-relaxed">
            WokoPay addresses liquidity challenges across Africa, delivering technology optimized for local market conditions.
          </p>
        </div>
